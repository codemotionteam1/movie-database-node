...
app.get('/actors', routes.getActors);
app.post('/actors', routes.addActor);
app.get('/actors/:id', routes.getActor);
app.put('/actors/:id', routes.updateActor);
// delete is a reserved word
app['delete']('/actors/:id', routes.deleteActor);